...
function AddItemModal({ editingItem, setEditingItem, setShowAddModal }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append("name", formatName(data.name));
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="relative w-full max-w-3xl bg-white sm:p-6 p-3 rounded-xl shadow-lg overflow-y-auto max-h-[92vh]">
        {/* Close Button */}
        <button
          onClick={() => {
            reset();
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="">
          ...
          <div className="flex flex-col gap-2 mb-3">
            ...
            <div className="flex gap-3">
              <label className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 border-1 border-emerald-600 rounded-lg cursor-pointer">
                <input
                  type="radio"
                  value="true"
                  {...register("isVeg")}
          ...
          <div className="flex flex-col gap-2 mb-3">
            ...
            <div className="flex gap-3 ">
              <label className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 border-1 border-emerald-500 rounded-lg cursor-pointer">
                <input
                  type="radio"
                  value="true"
          ...
          {/* Availability */}
          <label className="flex items-center gap-3 text-emerald-800 mb-2">
            <input
              type="checkbox"
          ...
          <div>
            ...
            {fields.map((item, index) => (
              <div key={item.id} className="flex items-center gap-3 my-2">
                ...
                <button
                  ...
                  className="text-red-500 bg-red-50 border-2 p-2.5 rounded-xl"
                >
                  <FaTrash />
                </button>
              </div>
            ...
            <button
              ...
              className="mt-2 px-4 py-2 bg-emerald-600 text-white rounded-xl flex items-center gap-2 shadow hover:bg-emerald-700"
            >
              <FaPlus /> Add Variant
            </button>
          </div>
          ...
          <button
            ...
            className="w-full flex justify-center items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3 rounded-xl mt-4 shadow"
          >
            <FaCheck />
            {editingItem ? (
              isSubmitting ? (
